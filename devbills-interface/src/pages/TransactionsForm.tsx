                ...
                {loading ? (
                  <div className="flex items-center justify-center">
                    {formData.type === TransactionType.EXPENSE ? (
                      <div className="w-4 h-4 border-4 border-red-700 border-t-transparent rounded-full animate-spin" />
                    ) : (
                      <div className="w-4 h-4 border-4 border-primary-700 border-t-transparent rounded-full animate-spin" />
                    )}
                  </div>
                ) : (
